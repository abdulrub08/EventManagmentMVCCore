...
namespace ScreenRecordedSoft.Capture
{
    public class RecorderParams
    {
        ...
        public IAviVideoStream CreateVideoStream(AviWriter writer)
        {
            if (Codec == KnownFourCCs.Codecs.Uncompressed)
                ...
                return writer.AddMpeg4VideoStream(Width, Height, Quality);
            else
            {
                return writer.AddMpeg4VideoStream(Width,Height,(double)writer.FramesPerSecond, //.AddMpeg4VideoStream(Width, Height, (double)writer.FramesPerSecond,
