...
namespace EventManagmentMVCCore.Security
{
    ...
    public class AesBase64Wrapper
    {
        ...
        private string PASSWORD = "PASSWORD_VALUE";
    ...
    public static class UrlEncryption
    {
        ...
        //    if (System.Web.HttpContext.Current == null) return relativeUrl;
        //    if (relativeUrl.StartsWith("/")) relativeUrl = relativeUrl.Insert(0, "~");
        //    if (!relativeUrl.StartsWith("~/")) relativeUrl = relativeUrl.Insert(0, "~/");
        //    var url = System.Web.HttpContext.Current.Request.Url;
        //    var port = url.Port != 80 ? (":" + url.Port) : String.Empty;
        //    return String.Format("{0}://{1}{2}{3}", url.Scheme, url.Host, port, System.Web.VirtualPathUtility.ToAbsolute(relativeUrl));
        //}
        ...
        public static string base64Encode(string sData) // Encode    
        {
            ...
            {
                throw new System.Exception("Error in base64Encode for encrypt user_login_id" + ex.Message);
            }
        }
        public static string base64Decode(string sData) //Decode    
        {
            ...
            {
                throw new System.Exception("Error in base64Decode  for decode user_login_id" + ex.Message);
            }
        }
    }
